        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>${row.cantidad_detalle_requisicion} ${row.unidad_contenido}</td>
                    <td>
                        <!-- Botón grande -->
                        <button type="button" onclick="openUpdate(${row.id_detalle_requisicion}, ${row.cantidad_detalle_requisicion}, '${row.unidad_contenido}')" class="btn btn-info btn-lg">
