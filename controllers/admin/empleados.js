                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class=" col-md-12 col-lg-3 card-body d-flex flex-column align-items-center text-center">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h5 class="">Nombre empleado</h5>
                                    <p class="card-title ">${row.nombre_empleado} ${row.apellido_empleado}</p>
                                    <h5 class="">DUI Empleado</h5>
                                    <p class="card-text ">${row.DUI_empleado}</p>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h5 class="">Teléfono empleado</h5>
                                    <p class="card-title ">${row.telefono_personal_empleado}
                                    <h5 class="">Departamento</h5>
                                    <p class="card-title ">${row.departamento_trabajo_empleado}
                                    <h5 class="">Municipio</h5>
                                    <p class="card-title ">${row.municipio_trabajo_empleado}
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-3 text-center my-5">
                            <div class="d-flex       flex-column">
                                <button class="btn btn-outline-dark mb-2" onclick="openDelete(${row.id_empleado})">
                                    <i class="bi bi-trash3-fill"></i> Eliminar
                                </button>
                                <button class="btn btn-outline-dark mb-2" onclick="openUpdate(${row.id_empleado})">
