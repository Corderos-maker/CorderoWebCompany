...
require_once('../../models/data/data_categoria_con.php');
        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    ...
                    $result['error'] = 'Ocurrió un problema al crear una categoría';
                }
                break;
            // ? Obtiene todos los registros de la tabla tb_categoria_consumibles.
            case 'readAll':
                if ($result['dataset'] = $categoria->readAll()) {
                    $result['status'] = 1;
                    $result['message'] = 'Existen ' . count($result['dataset']) . ' registros';
                } else {
                    $result['error'] = 'No existen categoria registrados';
                }
                break;
